...
{
    public static void Handle(bool verbose, string[] benchmarks, DirectoryInfo? repositoryPath, bool noDelete, string baselineRef, string? targetRef)
    {
        ...
        Console.WriteLine($"Target ref: {effectiveTargetRef}{(targetRef == null ? " (currently checked out version)" : "")}");
